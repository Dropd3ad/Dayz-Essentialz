...
{
    //Clouds
    const int OVERCAST_MIN_TIME = 900;
    const int OVERCAST_MAX_TIME = 1800;
    
    //Rain
    const float RAIN_THRESHOLD = 0.75;
    const int RAIN_TIME_MIN = 10;
    const int RAIN_TIME_MAX = 20;
    
    //Storm
    const float STORM_THRESHOLD = 0.9;
    
    //General Weather
    const int CLEAR_WEATHER_CHANCE = 85;
    const int BAD_WEATHER_CHANCE = 15;

    override void Init()
    {
        super.Init();
        
        m_MaxTemps = { 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20};
        m_MinTemps = { 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20};
    }
    ...
    override bool WeatherOnBeforeChange( EWeatherPhenomenon type, float actual, float change, float time )
    {
        ...
        m_Weather.SetWindMaximumSpeed( 25 );
